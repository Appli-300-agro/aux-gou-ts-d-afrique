# Aux Goûts D'afrique - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Aux Goûts D'afrique**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@auxgoutsdafrique.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@auxgoutsdafrique.cm` | `user123` | |
...
*   **Contact :** contact@auxgoutsdafrique.cm